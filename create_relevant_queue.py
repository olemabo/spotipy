...
def return_all_related_artists_to_list(artist_id, sp):
...
def find_random_artist_from_related_artists(artist_id, sp, how_random="uniform"):
    """
    ...
    """
    related_list = return_all_related_artists_to_list(artist_id, sp)
...
def add_x_random_top_track_from_random_follower(sp, number_of_tracks_to_add=1, random_artist="uniform", random_track="uniform"):
    ...
    for add in range(number_of_tracks_to_add):
        ...
        randomRelatedArtist_id_name_followers_popu = find_random_artist_from_related_artists(random_following_artist[0], sp, how_random=random_artist)
